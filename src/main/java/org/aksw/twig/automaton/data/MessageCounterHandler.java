...
public class MessageCounterHandler extends FileReadingSuspendSupplier<MessageCounter> {
    ...
    /**
     * Runs a {@link org.aksw.twig.executors.SelfSuspendingExecutor} with a {@link MessageCounterHandler} as {@link org.aksw.twig.executors.SuspendSupplier}.
     * Arguments must state a file to serialize the merged {@link MessageCounter}. Arguments must list files to parse and must be formatted as stated in {@link FileHandler#readArgs(String[])}.
